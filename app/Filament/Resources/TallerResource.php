...
class TallerResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Talleres';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('nombre')->label('Nombre del Taller')->required()->columnSpanFull(),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('nombre')->label('Taller')->columnSpanFull()->searchable(),
            ])
            ->filters([
                //
            ])
